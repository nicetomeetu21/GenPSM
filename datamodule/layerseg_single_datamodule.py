...
class spDatamodule(pl.LightningDataModule):
    def __init__(self, train_img_root, train_label_root, test_img_root, test_label_root, train_json_path, test_json_path,
                 image_size, crop_size, batch_size=1, num_workers=8, **kwargs):
        super().__init__()
        self.batch_size = batch_size
        self.num_workers = num_workers
        self.train_img_root = train_img_root
        ...
        print(len(self.train_pathes), len(self.test_pathes))
    ...
    def setup(self, stage=None):
        self.train_set = labeled_Dataset(img_root=self.train_img_root, label_root=self.train_label_root,
                                     pathes=self.train_pathes,
