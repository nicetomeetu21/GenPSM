...
from networks.modified_monai_vit_w_cond import ViTAutoEnc
import cv2 as cv
...
class DDPM(DDPM_base):
    ...
    def p_losses(self, x_start, t, cond):
        ...
        # print(x_noisy.shape, model_out.shape)
    ...
    def on_train_epoch_end(self):
        ...
        with self.ema_scope("Plotting"):
            ...
            # print(1)
            samples, denoise_row = self.sample(cond=[class_cond, shift_cond], batch_size=x.shape[0],
                                               return_intermediates=True, clip_denoised=True)
            # print(2)
            x = x * 0.5 + 0.5
