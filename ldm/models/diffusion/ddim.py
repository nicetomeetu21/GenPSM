...
class DDIMSampler(object):
    ...
    def ddim_sampling(self, cond, shape,
                      ...
                      unconditional_guidance_scale=1., unconditional_conditioning=None, dynamic_threshold=None, return_intermediates=False):
    ...
    def encode(self, x0, c, t_enc, use_original_steps=False, return_intermediates=None,
        ...
        intermediates = []
        inter_steps = []
        for i in tqdm(range(num_steps), desc='Encoding Image', mininterval=1):
